...
register(
    id='swimmer-medium-v0',
    entry_point='d4rl.gym_mujoco.gym_envs:get_swimmer_env',
    max_episode_steps=1000,
    kwargs={
        'deprecated': True,
        'dataset_url':'https://drive.google.com/uc?export=download&id=1dvuuwOfxtUq3FfTKEW-3aC9chubbVhJx'
    }
)

register( # 200 epoch
    id='reacher-medium-v0',
    entry_point='d4rl.gym_mujoco.gym_envs:get_reacher_env',
    max_episode_steps=1000,
    kwargs={
        'deprecated': True,
        'dataset_url':'https://drive.google.com/uc?export=download&id=1oh7O5Gg1FyM7BPjW30qOCEICKoDDKEN7'
    }
)
